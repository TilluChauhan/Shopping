<?php
	...
	if($name != "" && $quantity != "" &&  $size !="" &&  $color !="" &&  $price !=""){
		$sql = "insert into proadd (proadd_id, proadd_name,  proadd_quantity, proadd_size, proadd_color, proadd_squa, proadd_price, proadd_desc, proadd_front_img, proadd_side_img, proadd_back_img, status, created_date) values ('', '".$name."', '".$quantity."', '".$size."', '".$color."', '".$squa."', '".$price."', '".$desc."', '".$filename1."', '".$filename2."', '".$filename3."',  1, '".$date."')";
